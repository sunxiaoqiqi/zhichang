...
基于 Next.js、Drizzle ORM 和 SQLite 的职场沟通训练应用，包含用户登录、课程进度、训练题库、免费版/收费版授权、设备管理、数据分析及管理后台。

免费版账号可试读第 1 课并完成 1 次训练；收费版账号解锁全部 26 课和无限次训练。管理员可在“用户管理”中随时切换用户版本，用户的学习、收藏和统计数据不会因版本切换而丢失。
